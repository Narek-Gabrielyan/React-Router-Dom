            ...
            {albums.map((elm) => (
                <div className={alb.box} key={"albums" + elm.id}>
                    <div className={alb.box_item}>
                        <Tag_Span keys={Object.keys(elm)[1]} values={Object.values(elm)[1]} />
                        <Tag_Span keys={Object.keys(elm)[0]} values={Object.values(elm)[0]} />
                        <Tag_Span keys={Object.keys(elm)[2]} values={Object.values(elm)[2]} />
                    </div>
                </div>
            ))}
        </div>
